...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/trading-values`, lastModified: d, changeFrequency: "weekly", priority: 0.8 },
    { url: `${base}/ascension-guide`, lastModified: d, changeFrequency: "weekly", priority: 0.8 },
    { url: `${base}/soil-fertilizer`, lastModified: d, changeFrequency: "weekly", priority: 0.8 },
